      ...
      <div className="row">
        <div className="col-md-12">
          <div className="card card-body mb-3">
            ...
            {(profile.hobbies[0]) !== "" ? (<p><span className="profile-icon"><i className="fas fa-heart fa-fw"></i></span> {hobbies}</p>) : (<p className="hide"></p>)}
            {(profile.places[0]) !== "" ? (<p><span className="profile-icon"><i className="fas fa-map-pin fa-fw"></i></span> {places}</p>) : (<p className="hide"></p>)}
            {(profile.countries[0]) !== "" ? (<p><span className="profile-icon"><i className="fas fa-atlas fa-fw"></i></span> {countries}</p>) : (<p className="hide"></p>)}
          </div>
        </div>
      </div>
    );
