                ...
                <div className="container">
                    <div className="row">
                        ...
                        <form onSubmit={this.onSubmit.bind(this)}>
                            ...
                            <div className="form-group">
                            <input type="handle" className= {classnames("form-control form-control-lg", {'is-invalid': errors.handle})} placeholder="Handle" name="handle" value={this.state.handle} onChange={this.onChange.bind(this)}/>
